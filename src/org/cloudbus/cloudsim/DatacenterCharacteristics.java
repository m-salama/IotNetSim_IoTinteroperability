...
public class DatacenterCharacteristics {
	 ...
	 * @param costPerSec the cost per sec to use this resource (CPU)
	...
	public double getCostPerMi() {
		return getCostPerCPU() / getMipsOfOnePe();
	}
	 ...
	 */
	protected void setCostPerCPU(double costPerSecond) {
		this.costPerCPU = costPerSecond;
	}
