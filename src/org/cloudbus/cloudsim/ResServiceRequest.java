 ...
 */
public class ResServiceRequest {

	/** The Cloudlet object. */
	private final ServiceRequest cloudlet;
	 ...
	 * @post $none
	 */
	public ResServiceRequest(ServiceRequest cloudlet) {
	 ...
	 * @post $none
	 */
	public ResServiceRequest(ServiceRequest cloudlet, long startTime, int duration, int reservID) {
		this.cloudlet = cloudlet;
	...
	private void init() {
		...
		// hostList.
		cloudletFinishedSoFar = cloudlet.getServiceRequestFinishedSoFar() * Consts.MILLION;
	}
	...
	public int getServiceRequestId() {
		return cloudlet.getServiceRequestId();
	}
	...
	public long getServiceRequestLength() {
		return cloudlet.getServiceLength();
	}
	 ...
	 * @post $none
	 */
	public long getServiceRequestTotalLength() {
		return cloudlet.getServiceTotalLength();
	}
	 ...
	 * @post $none
	 */
	public int getServiceClassType() {
	 ...
	 * @post $none
	 */
	public boolean setServiceRequestStatus(int status) {
		// gets Cloudlet's previous status
		int prevStatus = cloudlet.getServiceRequestStatus();
		...
		try {
			...
			cloudlet.setServiceRequestStatus(status);
	 ...
	 * @post $result >= 0
	 */
	public long getRemainingServiceRequestLength() {
		long length = cloudlet.getServiceTotalLength() * Consts.MILLION - cloudletFinishedSoFar;
	 ...
	 * @post $none
	 */
	public void finalizeServiceRequest() {
		...
		if (cloudlet.getServiceRequestStatus()==Cloudlet.SUCCESS) {
			finished = cloudlet.getServiceLength();
		} else {
			finished = cloudletFinishedSoFar / Consts.MILLION;
		}

		cloudlet.setServiceRequestFinishedSoFar(finished);
	}
	 ...
	 * @post $none
	 */
	public void updateServiceRequestFinishedSoFar(long miLength) {
	 ...
	 * @post $result >= 0.0
	 */
	public double getServiceRequestArrivalTime() {
		return arrivalTime;
	}
	 ...
	 * @post $result >= -1.0
	 */
	public double getServiceRequestFinishTime() {
		return finishedTime;
	}
	...
	public int getServiceRequestStatus() {
		return cloudlet.getServiceRequestStatus();
	}
	...
	public String getUid() {
		return getUserId() + "-" + getServiceRequestId();
	}
