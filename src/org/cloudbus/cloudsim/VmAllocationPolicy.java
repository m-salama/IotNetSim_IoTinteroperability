...
public abstract class VmAllocationPolicy {
	...
	public abstract void addHost(Host newHost);
	
	public abstract void removeHost(Host host);

	public abstract void enableHost(Host newHost);
	
	public abstract void disableHost(Host host);
	 ...
	 * @post $none
	 */
	public abstract void enableVm(Vm vm);
	 ...
	 * @post $none
	 */
	public abstract void disableVm(Vm vm);
