...
public class ParkingHolon extends IoTNodeHolon implements IoTHolon {
	...
	public ParkingHolon(String name, 
			...
			String messagingProtocol,int total_parkingSlots, double parking_interval) {
	...
	private void processChangeParkingAvailability() {
		...
		schedule(getForwardNodeId(), CloudSim.getMinTimeBetweenEvents(), CloudSimTags.IOV_CLOUD_RECEIVE_DATA_EVENT, (double)pAvailability);
