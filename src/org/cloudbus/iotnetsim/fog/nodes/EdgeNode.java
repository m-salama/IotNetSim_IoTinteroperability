...
public abstract class EdgeNode extends SimEntity {
	...
	public void processEvent(SimEvent ev) {
		...
		case CloudSimTags.EDGE_NODE_RECEIVE_DATA_EVENT:
			processReceiveData(ev);
			break;
		case CloudSimTags.EDGE_NODE_FILTER_DATA_EVENT:
			processFilterData(ev);
			break;
		case CloudSimTags.EDGE_NODE_INTERPRET_DATA_EVENT:
			processInterpretData(ev);
			break;
		case CloudSimTags.EDGE_NODE_PROCESS_DATA_EVENT:
			processData(ev);
			break;
		case CloudSimTags.EDGE_NODE_SEND_DATA_EVENT:
			sendData();
			break;
		case CloudSimTags.EDGE_NODE_SEND_PROCESSED_DATA_EVENT:
			sendProcessedData();
			break;
		case CloudSimTags.EDGE_NODE_ACT_EVENT:
			processAct();
			break;
	...
	protected void processFilterData(SimEvent ev) {

	}
	
	protected void processInterpretData(SimEvent ev) {

	}
	
	protected void processData(SimEvent ev) {
	...
	protected void sendProcessedData() {
