...
import org.cloudbus.iotnetsim.iov.holon.ElectricChargingStationHolon;
import org.cloudbus.iotnetsim.iov.holon.ParkingHolon;
import org.cloudbus.iotnetsim.iov.holon.PetrolStationHolon;
...
public class MotorwayIoVHolonExample {
	/**
	...
	public static void main(String[] args) {
		...
		List<UserSmartPhoneHolon> lstUsers = new ArrayList<UserSmartPhoneHolon>();
		...
		try {
			...
			OutputStream output = new FileOutputStream(
					workingDir + "//src//experiments//results//MotorwayIoVexampleHolon_output.txt");
			Log.setOutput(output); // Uncomment to write output log in the txt files
			
			Log.printLine("Starting MotorwayIoV Holon simple experiment...");
	...
	private static void createTestbed(IoTDatacenterHolon datacenter, double change_interval, String datasetsFolder) {
		...
		PetrolStationHolon petrolStation_0 = new PetrolStationHolon(
				"PetrolStation_0",
		...
		ElectricChargingStationHolon electricChargingStation_0 = new ElectricChargingStationHolon(
		...
		//create Restaurant 
		RestaurantHolon restaurant_0 = new RestaurantHolon(
				"Restaurant_0", 
		...
		TrafficControlUnitHolon trafficControlUnit_0 = new TrafficControlUnitHolon(
...
//		m.processRequest();
	...
	private static List<UserSmartPhoneHolon> createUsers(IoTDatacenterHolon datacenter, List<UserSmartPhoneHolon> lstUsers) {
		//create user smart phone
		UserSmartPhoneHolon userSmartPhone_0 = new UserSmartPhoneHolon(
				"UserSmartPhone_P0",
				new Location(0, 0, 0),
		...
		VehicleHolon petrolVehicle_P0 = new VehicleHolon(
				"PetrolVehicle_0",
				new Location(0, 0, 0),
				IoTNodeType.VEHICLE,
				new NetConnection("4G", new NetConnectionType(), 100.00), 
		...
		//
		//userSmartPhone_0.setVehicleName("PetrolVehicle_0");
		
		//create user smart phone
		UserSmartPhoneHolon userSmartPhone_1 = new UserSmartPhoneHolon(
				"UserSmartPhone_E0",
				new Location(0, 0, 0),
				IoTNodeType.USER_SMART_PHONE,
				new NetConnection("4G", new NetConnectionType(), 100.00), 
		...
		VehicleHolon electricVehicle_0 = new VehicleHolon(
				"ElectricVehicle_E0",
				new Location(0, 0, 0),
				IoTNodeType.VEHICLE,
				new NetConnection("4G", new NetConnectionType(), 100.00), 
		...
		//userSmartPhone_1.setVehicleName("ElectricVehicle_E0");
